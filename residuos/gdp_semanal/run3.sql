CREATE DEFINER=root@localhost PROCEDURE Solarity.desglose_perdidas_test2(
    IN planta_id INT,
...
BEGIN
    ...
    IF agrupar_por_semana THEN
        SELECT 
            -- Calcular el lunes de la semana correspondiente y asignarlo a la columna fecha
            DATE_SUB(fecha, INTERVAL WEEKDAY(fecha) DAY) AS fecha,
